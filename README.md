...
After each having been on several deep runs, we feel that no immediate changes are required. We are however, contemplating allowing X-Items at the E4.
...
| Final Frontier | After Acquiring your 8th Gym badge, ~~Battle Items are now banned but~~ you gain one Bonus Pokémon Centre usage.  | Changed as of 21/11/25 - Battle Items are now usable for the entire run |
